...
if __name__ == "__main__":
  ...
  if minIndex == 1:
    print("平均色がもっとも全体に近い領域は，Left Top領域")
    print(f"その平均色 = ({avg_LT[0]:.3f}, {avg_LT[1]:.3f}, {avg_LT[2]:.3f})")
  elif minIndex == 2:
    print("平均色がもっとも全体に近い領域は，Right Top領域")
    print(f"その平均色 = ({avg_RT[0]:.3f}, {avg_RT[1]:.3f}, {avg_RT[2]:.3f})")
  elif minIndex == 3:
    print("平均色がもっとも全体に近い領域は，Left Bottom領域")
    print(f"その平均色 = ({avg_LB[0]:.3f}, {avg_LB[1]:.3f}, {avg_LB[2]:.3f})")
  elif minIndex == 4:
    print("平均色がもっとも全体に近い領域は，Right Bottom領域")
    print(f"その平均色 = ({avg_RB[0]:.3f}, {avg_RB[1]:.3f}, {avg_RB[2]:.3f})")
  elif minIndex == 5:
    print("平均色がもっとも全体に近い領域は，Central領域")
    print(f"その平均色 = ({avg_CT[0]:.3f}, {avg_CT[1]:.3f}, {avg_CT[2]:.3f})")

  if maxIndex == 1:
    print("平均色がもっとも全体と異なる領域は，Left Top領域")
    print(f"その平均色 = ({avg_LT[0]:.3f}, {avg_LT[1]:.3f}, {avg_LT[2]:.3f})")
  elif maxIndex == 2:
    print("平均色がもっとも全体と異なる領域は，Right Top領域")
    print(f"その平均色 = ({avg_RT[0]:.3f}, {avg_RT[1]:.3f}, {avg_RT[2]:.3f})")
  elif maxIndex == 3:
    print("平均色がもっとも全体と異なる領域は，Left Bottom領域")
    print(f"その平均色 = ({avg_LB[0]:.3f}, {avg_LB[1]:.3f}, {avg_LB[2]:.3f})")
  elif maxIndex == 4:
    print("平均色がもっとも全体と異なる領域は，Right Bottom領域")
    print(f"その平均色 = ({avg_RB[0]:.3f}, {avg_RB[1]:.3f}, {avg_RB[2]:.3f})")
  elif maxIndex == 5:
    print("平均色がもっとも全体と異なる領域は，Central領域")
    print(f"その平均色 = ({avg_CT[0]:.3f}, {avg_CT[1]:.3f}, {avg_CT[2]:.3f})")
